                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0 recent">
                                <div class="table-responsive custom-scrollbar">
                                    <h4>Not Listed Series</h4>
                                    <form action="series/insertseries" method="post">
                                        <table class="table">
                                            <tr>
                                                <td>API KEY</td>
                                                ...
                                                <td>MATCHES</td>
                                                <td><input type="text" name="matches" id="matches"> </td>
                                            ...
                                            <tr>
                                                <td>T20</td>
                                                <td><input type="text" name="t20" id="t20"> </td>
                                                <td>TEST</td>
                                                <td><input type="text" name="test" id="test"> </td>
                                                <td>SQUADS</td>
                                                <td><input type="text" name="squads" id="squads"> </td>
                                              

                                            </tr>
                                            <tr>  <td>AID</td>
                                                <td><input type="text" name="aid" id="aid"> </td></tr>
