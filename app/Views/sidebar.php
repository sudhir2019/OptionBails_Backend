...
<div class="sidebar-wrapper" data-layout="fill-svg">
          <div>
            ...
            <div class="logo-wrapper" style="height: 70px; width: 245px;">
              <!-- <a href="index.html">
                <img class="img-fluid" src="<?php echo base_url();?>/assets/images/logo/logo-icon.png" alt="" height="30px" width ="30px">
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="/dashboard">
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><span>Indices Master</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="<?= base_url("createIndices") ?>">Create Indice/Match</a></li>
                      <li><a href="/createTeam">Create Teams</a></li>
                      <li><a href="/createTeam">Create User</a></li>
                    </ul>
                  </li>
